...
paulify_add = function() {
    paulify_count += 1;
    var paulify_url = 'http://plaidirish.com/';
    ...
    if (paulify_count == 5) {
        ...
        if (!cssExisting) {
            ...
            css.type = 'text/css';
            css.rel = 'stylesheet';
            css.href = 'http://plaidirish.com/paulify.css';
            css.media = 'screen';
...
paulify_replace = function() {
    ...
    var hc = 6,
        hs, h, k;
    var words = ['Sexy', 'Cool Bro', 'Thats Hot', 'Cool', 'Nice Bro', 'Toats Mcgoats', 'Amazing', 'Sweet'];
    while (hc >= 1) {
